...
// Comparison of two pairs by (score, name) tuple
static bool zless(
...
// Update score of existing node (AVL tree reinsertion)
...
// Add new (score, name) tuple/update score of existing tuple
